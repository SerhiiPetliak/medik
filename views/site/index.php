...
$this->title = 'ІС медичного контролю';
?>
<div class="site-index">
	<div class="col-md-12">
		<div class="col-md-4">
			<div class="bl peopleBlock thumbnail">
                            <a href="http://medik/web/index.php?r=peoples">
                                <i class="glyphicon glyphicon-user"></i>
                            </a>
                            <a href="http://medik/web/index.php?r=peoples" class="strLink">Люди</a>
                            <p class="mpTools">
                                <a href="http://medik/web/index.php?r=peoples/create">
                ...
                <div class="col-md-4">
                    <div class="col-md-6">
                            <div class="bl streetBlock thumbnail">
                    ...
                    <div class="col-md-6">
                            <div class="bl workBlock thumbnail">
                    ...
                    <div class="col-md-6">
                            <div class="bl graftBlock thumbnail">
                    ...
                    <div class="col-md-6">
                            <div class="bl illBlock thumbnail">
                ...
                <div class="col-md-4">
			<div class="bl findBlock thumbnail">
